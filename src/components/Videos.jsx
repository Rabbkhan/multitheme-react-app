...
<VStack w={'full'}>
    ...
    <VStack alignItems={"flex-start"} p={'8'} width={"full"} overflowX={"auto"}>
            <Heading>Sample Video</Heading>
            <Text>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat eaque necessitatibus ipsa non praesentium. </Text>
        </VStack>
</VStack >
